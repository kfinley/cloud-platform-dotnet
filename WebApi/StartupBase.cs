...
namespace CloudPlatform.WebApi {
  ...
  public abstract class StartupBase {
    ...
    private void AddCoreServices(IServiceCollection services) {
      ...
      services
        ...
        if (this.MediatorAssembly != null)
          services.AddMediatR(this.MediatorAssembly);
        ...
        .AddJwtBearer(options => {
          ...
          options.TokenValidationParameters = new TokenValidationParameters {
            ...
            IssuerSigningKeyResolver = (s, securityToken, identifier, parameters) => {
              ...
              var json = AsyncHelper.RunSync(() => new System.Net.Http.HttpClient().GetStringAsync($"{parameters.ValidIssuer}/.well-known/jwks.json"));
      ...
      services
        .AddSwaggerGen(c => {
          c.SwaggerDoc("v1", new OpenApiInfo { Title = $"Cloud Platform {this.ServiceName} Api", Version = "v1" });
    ...
    public virtual void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
      if (env.IsDevelopment()) {
        ...
        app.UseSwagger();
        app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", $"Cloud Platform {this.ServiceName} Api v1"));
      }
